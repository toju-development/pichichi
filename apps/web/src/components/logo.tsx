...
export function Logo({
  ...
  const icon = (
    <svg
      ...
      style={{ height: sizes.iconSize, width: sizes.iconSize, display: "block" }}
      aria-hidden="true"
    >
      <defs>
      ...
      <circle cx="120" cy="120" r="120" fill={`url(#${greenId})`} />
      <circle
        cx="120"
        cy="120"
        r="111.6"
        ...
        strokeOpacity="0.85"
      />
      <path d={NINE_PATH} fill={`url(#${goldId})`} />
    </svg>
  );
