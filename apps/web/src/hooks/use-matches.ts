/**
 * Matches hooks — port literal de `apps/mobile/src/hooks/use-matches.ts`.
 *
 * Mismas query keys + mismo shape de params que mobile, así
 * `use-socket-events` invalida exactamente las mismas entradas en ambos clientes.
 */
