...
export class GroupResponseDto {
  ...
  @ApiPropertyOptional({
    description: '8-character invite code (only visible to admins)',
    example: 'AB3D5FG7',
  })
  ...
  @ApiProperty({
    description: 'Current user role in the group',
    enum: ['ADMIN', 'MEMBER'],
    example: 'ADMIN',
  })
  ...
  @ApiProperty({
    description: 'Current user total points in this group',
    example: 42,
  })
  userPoints!: number;
