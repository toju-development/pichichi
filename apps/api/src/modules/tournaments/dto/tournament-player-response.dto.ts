...
export class TournamentPlayerResponseDto {
  @ApiProperty({
    description: 'TournamentPlayer ID',
  ...
  @ApiPropertyOptional({
    description: 'External ID from API-Football',
    example: 154,
  })
  ...
  @ApiPropertyOptional({
    ...
    example: 'https://example.com/photos/messi.png',
  })
  ...
  @ApiPropertyOptional({
    ...
    example: 'https://example.com/logos/arg.png',
  })
  teamLogoUrl!: string | null;

  @ApiPropertyOptional({
    description: 'Team external ID from API-Football',
    example: 26,
  })
