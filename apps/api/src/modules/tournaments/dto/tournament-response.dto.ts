...
export class TournamentResponseDto {
  ...
  @ApiProperty({
    description: 'Whether the tournament is active',
    example: true,
  })
  isActive!: boolean;
  ...
  @ApiPropertyOptional({
    ...
    type: [TournamentPhaseResponseDto],
  })
  phases?: TournamentPhaseResponseDto[];

  @ApiPropertyOptional({
    description: 'Bonus prediction types',
    type: [TournamentBonusTypeResponseDto],
  })
  bonusTypes?: TournamentBonusTypeResponseDto[];

  @ApiPropertyOptional({
    description: 'Number of teams in the tournament',
    example: 32,
  })
  teamCount?: number;
}
